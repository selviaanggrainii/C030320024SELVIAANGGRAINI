...
<div class="widget-sidebar">
  ...
  <div class="sidebar-content">
    <ul class="list-sidebar">
      <?php 
      $artikel = $this->db->query("SELECT * FROM artikel,pengguna,dbsuratmasuk_selvia WHERE artikel_status='publish' AND artikel_author=pengguna_id AND artikel_kategori=id_surat ORDER BY artikel_id DESC LIMIT 3")->result();
...
<div class="widget-sidebar widget-tags">
  ...
  <div class="sidebar-content">
    <ul>
      <?php 
      $dbsuratmasuk_selvia = $this->m_data->get_data('dbsuratmasuk_selvia')->result();
      foreach($dbsuratmasuk_selvia as $k){
        ?>
        <li>
          <a href="<?php echo base_url().'dbsuratmasuk_selvia/'.$k->kategori_slug; ?>"><?php echo $k->pengirim; ?></a>
        </li>
        <?php
      }
      ?>
